...
/**
 * Enhanced RabbitMQ configuration for Payment Service with resilience patterns
 */
@Configuration
...
public class RabbitMQConfig {
    ...
    public ConnectionFactory connectionFactory() {
        ...
        logger.info("Payment Service RabbitMQ ConnectionFactory configured for {}:{}", host, port);
    ...
    public RabbitTemplate rabbitTemplate(ConnectionFactory connectionFactory) {
        ...
        template.setConfirmCallback((correlationData, ack, cause) -> {
            if (!ack) {
                logger.error("Payment service message not delivered to exchange: {}", cause);
            }
        });
        
        template.setReturnsCallback(returned -> {
            logger.error("Payment service message returned: {} - {} - {}",
                    returned.getMessage(),
