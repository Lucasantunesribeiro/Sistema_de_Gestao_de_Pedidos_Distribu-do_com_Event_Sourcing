 ...
 */
// @Service // Temporarily disabled for basic functionality
public class ResilientQueryService {
    ...
    /**
     * Process payment with intelligent fallback strategies using isolated thread
     * pool
     */
    ...
    private boolean isTemporaryFailure(Exception ex) {
        return ex instanceof SocketTimeoutException ||
                ...
                (ex instanceof HttpServerErrorException &&
                        HttpStatus.valueOf(((HttpServerErrorException) ex).getStatusCode()
