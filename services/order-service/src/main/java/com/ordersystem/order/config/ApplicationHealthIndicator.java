...
/**
 * Comprehensive application health indicator for Order Service
 * Aggregates all health checks and provides overall service status
 */
...
public class ApplicationHealthIndicator implements HealthIndicator {
    ...
    public Health health() {
        try {
            ...
            // Service information
            details.put("service", "Order Service");
            ...
            if (isHealthy) {
                ...
                details.put("message", "Order Service is fully operational");
                logger.debug("Order Service health check: HEALTHY");
                return Health.up().withDetails(details).build();
            } else {
                details.put("status", "UNHEALTHY");
                details.put("message", "One or more dependencies are not available");
                logger.warn("Order Service health check: UNHEALTHY - Database: {}, RabbitMQ: {}, Startup: {}", 
            ...
            logger.error("Order Service application health check failed", e);
            return Health.down()
