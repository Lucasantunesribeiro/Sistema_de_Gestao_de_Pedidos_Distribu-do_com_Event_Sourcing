...
public class RedisEventPublisher {
    ...
    public void publishOrderCreatedEvent(OrderCreatedEvent event) {
        ...
        logger.info(
                "🚀 Publishing OrderCreatedEvent to Redis Stream: orderId={}, customerId={}, totalAmount={}, stream={}, correlationId={}",
        ...
        try {
            ...
            logger.info(
                    "✅ Successfully published OrderCreatedEvent to Redis Stream: orderId={}, stream={}, correlationId={}",
                    event.getOrderId(), ORDER_EVENTS_STREAM, correlationId);

        } catch (Exception e) {
            logger.error(
                    "❌ Error publishing OrderCreatedEvent to Redis Stream: orderId={}, stream={}, error={}, correlationId={}",
    ...
    public void publishOrderStatusUpdatedEvent(OrderStatusUpdatedEvent event) {
        ...
        logger.info(
                "🚀 Publishing OrderStatusUpdatedEvent to Redis Stream: orderId={}, {} -> {}, stream={}, correlationId={}",
        ...
        try {
            ...
            logger.info(
                    "✅ Successfully published OrderStatusUpdatedEvent to Redis Stream: orderId={}, {} -> {}, stream={}, correlationId={}",
                    event.getOrderId(), event.getOldStatus(), event.getNewStatus(), ORDER_EVENTS_STREAM, correlationId);

        } catch (Exception e) {
            logger.error(
                    "❌ Error publishing OrderStatusUpdatedEvent to Redis Stream: orderId={}, {} -> {}, stream={}, error={}, correlationId={}",
                    event.getOrderId(), event.getOldStatus(), event.getNewStatus(), ORDER_EVENTS_STREAM, e.getMessage(),
                    correlationId, e);
